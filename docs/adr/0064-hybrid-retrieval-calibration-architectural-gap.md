...
- Status: Accepted (calibration attempted; **architectural-gap half closed by [ADR-0065](0065-knowlex-ci-credentials-provider.md) v0.5.15**; **lift-figure half reframed as BYOK-reproducible per [ADR-0067](0067-gemini-free-tier-account-revocation-incident.md) § Decision item 2** — any operator with a Gemini-compatible or 768-dim-equivalent API key can produce the lift figure by running the calibration recipe locally)
- Date: 2026-04-29
