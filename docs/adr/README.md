...
| [0047](0047-knowlex-workspace-tenancy-plan.md)                  | Knowlex workspace tenancy — plan and scoped migration                                                     | Partially Accepted (v0.5.0 schema partitioning; access control deferred to v0.5.2) |
