...
[![Tests: 216 Vitest + 24 Playwright](https://img.shields.io/badge/tests-216%20%2B%2024-success)](./apps/collab)
...
- ✅ **Week 3** — Prisma schema (17 models), Auth.js v5 OAuth (Google+GitHub), 4-tier RBAC, initial Vitest suite (40 cases at the time, now **216**)
