...
export const metadata = {
  title: "API Reference",
  description:
    "Full OpenAPI 3.1 reference for the Boardly REST surface. Hand-written spec; interactive request / response explorer available at editor.swagger.io via /api/openapi.json.",
};

/**
 * Server-rendered API reference.
 *
 * Renders `openApiSpec` (the same hand-written OpenAPI 3.1 object that
 * serves /api/openapi.json) as a searchable, grouped-by-tag reference.
 * Advantages over linking out to Swagger Editor:
 *   - Stays inside our strict CSP (no external script fetch)
 *   - Indexable by search engines → hits recruiter's google queries
 *   - Full control over styling to match the rest of the portfolio
    ...
    <main className="min-h-screen bg-neutral-950 text-neutral-100">
      ...
      <footer className="border-t border-neutral-800">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-3 px-6 py-6 text-xs text-neutral-500">
          <span>
            Generated from{" "}
            <code className="text-neutral-400">src/openapi.ts</code>. Typed
            client via{" "}
            <code className="text-neutral-400">pnpm generate:api-types</code>.
          </span>
