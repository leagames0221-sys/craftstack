...
export const metadata = {
  ...
  description:
    "Two production-grade SaaS built from schema to deploy: Boardly (realtime collaborative kanban) and Knowlex (AI knowledge retrieval with pgvector + HNSW). Grade-A security headers, 276 Vitest + 24 Playwright tests, zero-dollar infra.",
};
